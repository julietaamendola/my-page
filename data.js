...
var POSTS = [
  {
    ...
    activo: true,
    contenido_es:
      '<p>Este texto lo escribí para leerlo en el club de lectura que tengo con amigos. Nos juntamos cada tanto a compartir lo que estuvimos leyendo. Cuando terminé El hombre en busca de sentido, escribí esto para llevar esa tarde. Al final decidí publicarlo acá también. </p>'
      + '<p>Hay una escena cerca del final del libro que no me abandona. Los prisioneros acaban de ser liberados. Después de años de campos, de frío, de hambre, de ver morir a los que estaban al lado: de repente, campo abierto. Frankl describe cómo algunos empiezan a caminar entre las plantas y las flores, y simplemente las pisan. Sin malicia y sin conciencia. Como si la libertad recién recuperada no supiera todavía qué hacer consigo misma. Él se detiene en eso y les llama la atención. Dice algo que me pareció destacable: la libertad sin sentido puede volverse tan destructiva como la opresión.</p>'
